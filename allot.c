 ...
 *
 * @pt: Pointer to the previous malloc'ated block.
 * @pre_size: Byte size of the previous block.
 * @new_size: Byte size of the new block.
 * Return: Pointer to the reallocated block of memory.
 * If 'new_size' is 0 and 'ptr' is not NULL, the memory is freed
 */
 ...
 *
 * @m: Pointer to the memory area to be filled.
 * @b: The byte value to fill 'm' with.
